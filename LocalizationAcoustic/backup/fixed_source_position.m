...
arrays = [2.69, 0.19; 
           ...
           2.70, 5.27; 
           0.37, 3.54];
mics = [2.69-d/2, 0.19; 2.69+d/2, 0.19; 
           5.19, 3.21-d/2; 5.19, 3.21+d/2;
           2.70+d/2, 5.27; 2.70-d/2, 5.27;
           0.37, 3.54+d/2; 0.37, 3.54-d/2];
% simulated recording
x=nktp_sim(f,y,[2, 3],ones(1,8),5*ones(1,8),1, mics);
